...
class _AddEditCourtScreenState extends ConsumerState<AddEditCourtScreen> {
  ...
  void initState() {
    ...
    _openTimeController = TextEditingController(text: widget.court?.openTime ?? '05:00');
    _closeTimeController = TextEditingController(text: widget.court?.closeTime ?? '22:00');
        ...
        child: ListView(
          ...
          children: [
            ...
            TextFormField(
              ...
              decoration: const InputDecoration(labelText: 'Giá mỗi giờ', border: OutlineInputBorder(), suffixText: 'đ'),
              ...
              children: [
                Expanded(
                  child: TextFormField(
                    ...
                    decoration: const InputDecoration(labelText: 'Mở cửa', border: OutlineInputBorder(), hintText: '05:00'),
                  ),
                ),
                ...
                Expanded(
                  child: TextFormField(
                    ...
                    decoration: const InputDecoration(labelText: 'Đóng cửa', border: OutlineInputBorder(), hintText: '22:00'),
                  ),
                ),
              ],
            ),
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                ...
                onPressed: _saveForm, 
                child: const Text('LƯU THÔNG TIN SÂN', style: TextStyle(fontWeight: FontWeight.bold)),
              ),
            )
          ],
        ),
